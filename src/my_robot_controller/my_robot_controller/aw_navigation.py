...
class AWNavigationNode(Node):
    ...
    def __init__(self):
        ...
        self.goal_poses.append({'x': 3694.478, 'y': 73729.523, 'z':0.862, 'w': 0.505})
        self.goal_poses.append({'x': 3766.84, 'y': 73796.742, 'z':0.268, 'w': 0.963})
        self.goal_poses.append({'x': 3827.455, 'y': 73724.625, 'z':-0.969, 'w': 0.246})
